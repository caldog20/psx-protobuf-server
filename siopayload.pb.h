...
#define SIOPayload_init_default                  {0, {DataTransfer_init_default}}
#define FlowControl_init_zero                    {0, 0}
#define DataTransfer_init_zero                   {{{NULL}, NULL}}
#define SIOPayload_init_zero                     {0, {DataTransfer_init_zero}}
...
X(a, STATIC,   ONEOF,    MESSAGE,  (type,data_transfer,type.data_transfer),   1) \
X(a, STATIC,   ONEOF,    MESSAGE,  (type,flow_control,type.flow_control),   2)
